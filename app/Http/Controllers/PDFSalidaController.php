...
class PDFSalidaController extends Controller
{
    public function generatePDF()
    {
        ...
        // Renderizar la vista "pdf.salidas_pdf" con los datos proporcionados
        $html = View::make('pdf.salidas_pdf', compact('salidas'))->render();
