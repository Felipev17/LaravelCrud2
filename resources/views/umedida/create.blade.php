        ...
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Registrar una unidad de medida</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('umedida.store') }}" method="POST">
                        @csrf
                        
                        <div class="form-group">
                            <label for="umedida">Unidad de medida</label>
                            <input type="text" name="umedida" id="umedida" class="form-control" required>
                        </div>
                       
                        <button type="submit" class="btn btn-primary">Guardar</button>
                        <button><a href="{{ route('umedida.index') }}" class="btn btn-secondary">Cancelar</a></button>
                    </form>
                </div>
            </div>
        </div>
